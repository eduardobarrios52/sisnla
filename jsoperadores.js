             ...
             $(function () {
                ...
                $('#fileuploader').hide();
                var idoperadoredit = 0;
                var idoperadorelim = 0;
                var imgmarcaed = 0;
                $("#btnagregarc").on('click', function () {
                    if ($("#Nombre").val().trim().length >= 1 ) {
                        form = $('#agregar');
                        
                        $.ajax({url: "agregaroperador.php",
                            type: 'GET',
                            data: form.serialize(),
                            success: function (result) {
                                location.reload();
                ...
                $(".acivarmarca").click(function () {
                    idoperadoredit = $(this).attr("dataidc");
                    ...
                    var parametros = {
                        "idoperador": idoperadoredit
    
                    };
                    $.ajax({url: "activaroperador.php",
                        type: 'GET',
                        data: parametros,
                        success: function (result) {
                            //alert(result);
                ...
                $(".elimmarca").click(function () {
                    idoperadorelim = $(this).attr("dataidc");
                    $('#modaleliminar').modal('show');
                });
    
                $("#btnmelimtalla").click(function () {
                    var parametros = {
                        "idoperador": idoperadorelim
                    };
                    $.ajax({url: "eliminaroperador.php",
                        type: 'GET',
                        data: parametros,
                        success: function (result) {
                            //alert(result);
