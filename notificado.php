...
<html>
            ...
            <div class="row">
                ...
                <div id="content" class="col-md-12">
                    ...
                    <div class="pageheader">
                        <h2><i class="fa fa-users" style="line-height: 48px;padding-left: 0;"></i> Notificado </h2>
                    </div>
                    <!-- /page header -->
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h1><strong>Agregar</strong> Notificado</h1>
                                                    </div>
                                ...
                                <form id="editar">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Cerrar</button>
                                                <h1><strong>Editar</strong> Notificado</h1>
                                            </div>
                                            <div class="modal-body">
                                                        <input type="hidden" id="idnotificado" name="idnotificado">
                                                        <div class="form-group">
                                                            <label for="exampleInput">Nombre de Notificado</label>
                            ...
                            <div class="modal fade" id="modalactivar" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Cerrar</button>
                                            <h3 class="modal-title" id="modalConfirmLabel"><strong>Activar</strong> Notificado</h3>
                                        </div>
                                        <div class="modal-body">
                                            <section class="tile transparent">
                            ...
                            <div class="modal fade" id="modaleliminar" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Cerrar</button>
                                            <h3 class="modal-title" id="modalConfirmLabel"><strong>Desactivar</strong> Notificado</h3>
                                        </div>
                                        <div class="modal-body">
                                            <section class="tile transparent">
                                                <div class="jumbotron bg-transparent-black-3">
                                    ...
                                    <div class="table-responsive">
                                        <table style=" display: block; overflow-x: auto; white-space: nowrap;"  class="table table-datatable table-custom  table-hover" id="basicDataTable">
                                            ...
                                            <tbody>
                                                ...
                                                $consulta = "SELECT p.* , pa.descripcion as residencia, pai.descripcion as paiss, e.nombre as Esta, m.descripcion as Mun, c.nombre as col FROM notificado p inner join pais pa on p.ResidenciaFiscalNotificado = pa.clave inner join pais pai on p.Pais = pai.clave inner join estados e on e.c_Estado = p.Estado inner join municipios m on m.c_municipio = p.Municipio and m.c_Estado = p.Estado inner join colonias c on c.c_Colonia = p.Colonia and c.c_CodigoPostal = p.CodigoPostal ORDER BY idnotificado";
    ...
    <script src="jsnotificado.js"></script>
</body>
</html>
 <?php
} else {
