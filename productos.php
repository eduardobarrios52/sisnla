...
<html>
            ...
            <div class="row">
                ...
                <div id="content" class="col-md-12">
                    ...
                    <div class="pageheader">
                        <h2><i class="fa fa-users" style="line-height: 48px;padding-left: 0;"></i> PRODUCTOS </h2>
                    </div>
                    <!-- /page header -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <section class="tile transparent">
                                    ...
                                    <!-- /tile header -->
                                    <!-- tile body -->
                                    <div class="modal fade" id="agregartalla" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true" style="display: none;">
                                        <form id="agregar">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Cerrar</button>
                                                        <h1><strong>Agregar</strong> Producto</h1>
                                                    </div>
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-12 control-label">Clave Producto Servicio</label>
                                                            <div class="form-group">
                                                                <label for="exampleInput"></label>
                                                                <select id="claveprodserv" name="claveprodserv" class="form-control">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-12 control-label">Clave Unidad</label>
                                                            <div class="form-group">
                                                                <label for="exampleInput"></label>
                                                                <select id="claveuniprod" name="claveuniprod" class="form-control">
                            ...
                            <div class="modal fade" id="editartalla" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true" style="display: none;">
                                <form id="editar">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Cerrar</button>
                                                <h1><strong>Editar</strong> Producto</h1>
                                            </div>
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleInput"></label>
                                                        <select id="claveprodserve" name="claveprodserv" class="form-control">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                    <label for="exampleInput"></label>
                                                        <select id="claveuniprode" name="claveuniprod" class="form-control">
                                    ...
                                    <div class="table-responsive">
                                        <table style=" display: block; overflow-x: auto; white-space: nowrap;"  class="table table-datatable table-custom  table-hover" id="basicDataTable">
                                            ...
                                            <tbody>
                                                ...
                                                $consulta = "SELECT p.*, u.nombre unidadn, s.Descripcion servicio FROM productos p inner join unidad u on u.clave = p.unidad inner join claveprodserv s on s.c_ClaveProdServ = p.claveprodserv";
                                                ...
                                                if ($num >= 1) {
                                                    while ($rs = $res->fetch_assoc()) {
                                                        ?>
                                                        <tr class="odd gradeX">
                                                            <td id="tdnom<?php echo utf8_encode($rs['idproducto']); ?>"><?php echo $rs['nombre']; ?></td>
    ...
    <script src="jsproducto.js"></script>
</body>
</html>
 <?php
} else {
