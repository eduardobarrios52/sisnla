...
<body><div id="loginform">
        <div id="facebook"><img src="assets/images/logoblanco.png" width="100%"></img><div id="connect">Intranet 2.0</div></div>
<div id="mainlogin">
<div id="or">-</div>
<h1>Administración de noticias</h1>
<form action="filtroatn.php" method="post">
<input name="usuario" type="text" placeholder="Usuario" value="" required/>
<input name="contra" type="password" placeholder="Contraseña" value="" required/>
<button type="submit"><i class="fa fa-arrow-right"></i></button>
</form>
<div id="note"><a href="index.php">Regresar al inicio</a></div>
</div>
</div>
</body>
</html>
