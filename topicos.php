...
if ($_SESSION[access] == true) {
                ...
                <div class="row">
                    ...
                    <div id="content" class="col-md-12">
                        ...
                        <div class="pageheader">
                            <h2><i class="fa fa-users" style="line-height: 48px;padding-left: 0;"></i> TOPICOS </h2>
                        </div>
                        <!-- /page header -->
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h1><strong>Agregar</strong> Topico</h1>
                                                    </div>
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-12 control-label">Descripcion del topico</label>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="aarea">
                                ...
                                <div class="modal fade" id="editartalla" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Cerrar</button>
                                                <h1><strong>Editar</strong> Topico</h1>
                                            </div>
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="exampleInput">Nombre</label>
    ...
    $consulta = "SELECT * FROM topicos ORDER BY activo, idarea,nombre desc";
    //echo $consulta;
        ...
        while ($rs = $res->fetch_assoc()) {
            ?>
                                                            ...
                                                            <tr class="odd gradeX">
                                                                ...
                                                                <td id="tdnom<?php echo utf8_encode($rs['idtopico']); ?>"><?php echo $rs['nombre']; ?></td>
                                                                <td id="tddesc<?php echo utf8_encode($rs['idtopico']); ?>"><?php echo $rs['descripcion']; ?></td>
                                                                <td id="tdarea<?php echo utf8_encode($rs['idtopico']); ?>" data-id="<?php echo $rs['idarea']; ?>"><?php
                                                $consulsel = 'SELECT * FROM area where activo =1 and idarea=' . $rs['idarea'];
                                                $resel = $mysqli->query($consulsel);
                                                while ($rss = $resel->fetch_assoc()) {
            ...
            ?></td>
                                                                <td><button dataidc="<?php echo utf8_encode($rs['idtopico']); ?>" type="button" class="btn edittitle btn-warning margin-bottom-20">Editar Topico</button></td>
                                                                    <?php if ($rs['activo'] == 1) {
                                                                        ?>
                                                                    <td><button dataidc="<?php echo utf8_encode($rs['idtopico']); ?>" type="button" class="btn elimmarca btn-danger margin-bottom-20">Desactivar topico</button></td>

                                                                    <?php
                                                                } else {
                                                                    ?>
                                                                    <td><button dataidc="<?php echo utf8_encode($rs['idtopico']); ?>" type="button" class="btn acivarmarca btn-green margin-bottom-20">Activar topico</button></td>
