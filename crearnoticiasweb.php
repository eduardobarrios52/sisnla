...
//values(1,1,(select max(cve_not)+1 from noticias),'titulo','descripcion',1,CURRENT TIMESTAMP,1,1)   (select max(cve_not)+1 from noticias)     
                                    ...
                                    $consultanot = 'insert into noticiasweb(titulo,descripcion,url,estatus,fecha) ' .
...
//	This is for custom errors;
    ...
    if (!is_array($_FILES["adjunto"]["name"])) { //single file
        ...
        if (move_uploaded_file($file_tmp, $ruta1)) {
            ...
            @chmod($ruta, 0777);
            umask($save);
            $consultanotup = 'update noticiasweb set ruta=\'' . $ruta . '\' where idnoticia=\'' . $consultamax . '\'' ;
            ...
            ?>
                  ...
                  <div class="jumbotron bg-transparent-black-3">
                    ...
                    <div class="container text-center">
                      <h1>BLOG CREADO</h1>
                      <p>El blog fue creado con exito</p>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <section class="tile color transparent-black">
                                            ...
                                            <div class="tile-header">
                                                <h1><strong>Crear</strong> Blog</h1>
                                                <div class="controls">
                                            ...
                                            <!-- tile body -->
                                            <div class="tile-body">
                                                <form class="form-horizontal" role="form" method="post" action="crearnoticiasweb.php" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group transparent-editor">
                                                                <label for="input06" class="col-sm-4 control-label">Contenido informativo</label>
                                                                <div class="col-sm-8">
