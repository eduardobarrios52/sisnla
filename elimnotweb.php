            ...
            <div class="row">
                ...
                <div id="content" class="col-md-12">
                    ...
                    <div class="pageheader">
                        ...
                        <h2>Eliminacion de  <span>// Blogs...</span></h2>
                                    ...
                                    <div class="table-responsive">
                                        <table style=" display: block; overflow-x: auto; white-space: nowrap;"  class="table table-datatable table-custom  table-hover" id="basicDataTable">
                                            ...
                                            <tbody>
                                                ...
                                                $consulta = "SELECT * FROM noticiasweb where estatus=1";
...
<td ></td>
                                                            ...
                                                            <td id="tddesc<?php echo utf8_encode($rs['idnoticia']); ?>">
                                                                <a target="_blank" href="docblog/<?php echo $rs['ruta']; ?> " >Ver archivo </a>
                                                                </td>
                                                                 <td>
                                                                    
                                                                     
                                                                     <button dataidc="<?php echo $rs['idnoticia']; ?>" type="button" class="btn elimmarca btn-danger margin-bottom-20">Eliminar Blog</button>
                                           </td>
                                                        </tr> 
                                                        <?php
                                                    }
