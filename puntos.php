            ...
            <div class="row">
                ...
                <div id="content" class="col-md-12">
                    ...
                    <div class="pageheader">
                        <h2><i class="fa fa-user" style="line-height: 48px;padding-left: 0;"></i> Puntos </h2>
                    </div>
                    <!-- /page header -->
                                    ...
                                    <form id="agregar">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Cerrar</button>
                                                    <h1><strong>Agregar</strong> Punto</h1>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="NumRegIdTrib" name="NumRegIdTrib">
                            ...
                            <form id="editar">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Cerrar</button>
                                                    <h1><strong>Editar</strong> Punto</h1>
                                                </div>
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="NumRegIdTribNotificado"></label>
                                                            <input type="text" class="form-control" id="NumRegIdTribe" name="NumRegIdTrib">
                            ...
                            <div class="modal fade" id="modaleliminar" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Cerrar</button>
                                            <h3 class="modal-title" id="modalConfirmLabel"><strong>Desactivar</strong> Punto</h3>
                                        </div>
                                        <div class="modal-body">
                                            ...
                                            <tbody>
                                                ...
                                                if ($num >= 1) {
                                                    ...
                                                    while ($rs = $res->fetch_assoc()) {
                                                        ?>
                                                        <tr class="odd gradeX">
                                                            <td id="tdnom<?php echo utf8_encode($rs['idpuntos']); ?>"><?php echo $rs['nombre']; ?></td>
                                                            <td id="tdamat<?php echo utf8_encode($rs['idpuntos']); ?>"><?php echo $rs['rfc']; ?></td>
